...
export default function ForgotPasswordPage() {
  return (
    <div className="grid min-h-screen bg-white lg:grid-cols-2">
      ...
      <div className="relative flex items-start justify-center overflow-hidden px-5 pb-[max(2rem,env(safe-area-inset-bottom))] pt-20 sm:px-6 sm:pb-12 sm:pt-24 lg:items-center lg:py-12">
