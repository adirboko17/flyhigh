...
export function TrackScheduleFields({
  ...
  return (
    <div className="space-y-4 rounded-2xl border border-ink-100 bg-ink-50/50 p-4">
      ...
      <label className="flex cursor-pointer items-start gap-3">
        ...
        <span>
          ...
          <span className="mt-0.5 block text-xs text-ink-500">
            אחרי רכישה הבקשה תופיע בעמוד תיאום מועדים. משם מתאמים תאריך, והמדריכה
            תוכל לסמן נוכחות.
          </span>
        </span>
      </label>
      ...
      <Field
        label="מדריכה (פנימי)"
        hint="רק הצוות רואה את השיוך. הלקוח לא. המדריכה המשויכת תוכל לסמן נוכחות לכל המועדים שתואמו."
      >
        <InstructorSelect
          value={instructorId}
