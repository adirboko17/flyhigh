...
export function CtaSection() {
  return (
    <section className="container-page pb-[72px]">
      <div className="relative overflow-hidden rounded-[32px] bg-[linear-gradient(120deg,#0a4a71_0%,#0072b8_60%,#0c97cc_100%)] px-5 py-10 text-center text-white shadow-[0_30px_60px_-28px_rgba(10,74,113,0.6)] sm:px-8 sm:py-14">
        ...
        <div className="relative">
          ...
          <h2 className="mt-4 font-display text-2xl font-extrabold tracking-tight sm:text-[40px]">
            מוכנים לקפוץ למים?
          </h2>
          <p className="mx-auto mt-2.5 max-w-[560px] text-[15px] text-white/88 sm:text-[17px]">
